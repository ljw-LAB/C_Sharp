...
namespace ex4_24
{
    ...
    class Program
    {
        ...
        {
            Book book1 = new Book(9788998139018, "리버스 엔지니어링 바이블", "가나다라마바사");
            Book book2 = new Book(9788998139018, "리버스 엔지니어링 바이블", "가나다라마바사");
            Book book3 = new Book(9788992939409, "파이썬 3.6 프로그래밍", "아자차카타파하");
