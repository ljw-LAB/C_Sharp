...
namespace ex8_14
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new MainLanguage {Name = "Anders", Lanaguage = "Delphi"},
                new MainLanguage {Name = "Anders", Lanaguage = "C#"},
                new MainLanguage {Name = "Tom", Lanaguage = "Borland C++"},
                new MainLanguage {Name = "Hans", Lanaguage = "Visual C++"},
                new MainLanguage {Name = "Winnie", Lanaguage = "R"},
            };
